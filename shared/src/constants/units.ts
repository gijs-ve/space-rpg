...
export const UNITS: Record<UnitId, UnitDef> = {
  ...
  levy_spearman: {
    ...
    trainingTime: 60,
    cost: { ...EMPTY_RESOURCES, ore: 15, fuel: 10 },
  ...
  sergeant: {
    ...
    trainingBuildingLevel: 1,
    trainingTime: 90,
    cost: { ...EMPTY_RESOURCES, alloys: 30, ore: 10, fuel: 5 },
  ...
  man_at_arms: {
    ...
    trainingTime: 150,
    cost: { ...EMPTY_RESOURCES, alloys: 60, ore: 20 },
  ...
  levy_archer: {
    ...
    trainingBuildingLevel: 1,
    trainingTime: 60,
    cost: { ...EMPTY_RESOURCES, fuel: 15, ore: 5 },
    upkeep: { ...EMPTY_RESOURCES, rations: 1 },
  ...
  longbowman: {
    ...
    trainingBuildingLevel: 2,
    trainingTime: 90,
    cost: { ...EMPTY_RESOURCES, alloys: 20, fuel: 20, ore: 10 },
    upkeep: { ...EMPTY_RESOURCES, rations: 2 },
  ...
  arbalestier: {
    ...
    trainingTime: 120,
    cost: { ...EMPTY_RESOURCES, alloys: 50, ore: 20, fuel: 10 },
    upkeep: { ...EMPTY_RESOURCES, rations: 2, alloys: 1 },
  ...
  chevaucheur: {
    ...
    trainingBuildingLevel: 1,
    trainingTime: 180,
    cost: { ...EMPTY_RESOURCES, alloys: 35, rations: 15, fuel: 10 },
    upkeep: { ...EMPTY_RESOURCES, rations: 3, fuel: 1 },
  ...
  knight: {
    ...
    trainingBuildingLevel: 2,
    trainingTime: 360,
    cost: { ...EMPTY_RESOURCES, alloys: 120, ore: 30, rations: 20, iridium: 5 },
    upkeep: { ...EMPTY_RESOURCES, rations: 5, fuel: 2 },
  ...
  trebuchet: {
    ...
    trainingBuildingLevel: 1,
    trainingTime: 480,
    cost: { ...EMPTY_RESOURCES, fuel: 100, ore: 80, alloys: 40 },
